...
public class HanlpTest {
    ...
    public static void segment() {
        String fileName = App.class.getResource("/testdata.txt").getFile();
        ...
        Segment segment1 = new CRFSegment();
        segment1.enablePartOfSpeechTagging(true);
        List<Term> crftermList = segment1.seg("你看过穆赫兰道吗");
     ...
     * 频次最高的5个关键词
     */
    public static void extractKeyword() {
     ...
     * @return
     */
    public static void hanLPSegment(){
        String text = "我是中国人，我爱我的祖。周末我要去东湖绿道骑自行车，有没有想参与的。在东湖，我看到了卖气球的老爷爷。";
     ...
     * @Date：
     */
    public static void suggest_test(){
        ...
        String[] titleArray =
                (
                        "威廉王子发表演说 呼吁保护野生动物\n" +
                                ...
                                "英报告说空气污染带来“公共健康危机”\n"+
                                "我国首家！又一“巨头”进场，目标“直指”支付宝，马云如何接招"
                ).split("\\n");
     ...
     * @Date：
     */
    public static void nameRecognize(){
